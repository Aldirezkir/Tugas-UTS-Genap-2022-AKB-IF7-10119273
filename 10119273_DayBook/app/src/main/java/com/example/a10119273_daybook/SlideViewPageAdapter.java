    ...
    public Object instantiateItem(@NonNull ViewGroup container, int position) {
        ...
        switch (position)
        {
            case 0:
                ...
                tittle.setText("DayBook");
                desc.setText("Catat Aktivitas Harianmu !");
            ...
            case 1:
                ...
                tittle.setText("");
                desc.setText("Membantu anda Mencatat kegiatan sehari-hari");
                back.setVisibility(view.VISIBLE);
                next.setVisibility(view.VISIBLE);
                break;

            case 2:
                logo.setImageResource(R.drawable.img_spalsh3);
                ind1.setImageResource(R.drawable.unselected);
                ind2.setImageResource(R.drawable.unselected);
                ind3.setImageResource(R.drawable.selected);

                tittle.setText("");
                desc.setText("Buat Aktivitas anda lebih Teratur !");
                back.setVisibility(view.VISIBLE);
